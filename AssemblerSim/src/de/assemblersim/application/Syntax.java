 ...
 */
public class Syntax extends DefaultStyledDocument {
	...
	StyleConstants.setForeground(DEFAULT_COMMENT, new Color(29, 166, 45)); // green
	...
	StyleConstants.setForeground(DEFAULT_STRING, new java.awt.Color(153, 0,
		107)); // dark pink
	...
	StyleConstants.setForeground(DEFAULT_KEYWORD, new java.awt.Color(0, 0,
		153)); // dark blue
    ...
    ExtendedJEditorPane edit;
    EditorKit editorKit;

    public Syntax(final HashMap<String, MutableAttributeSet> keywords) {
	doc = this;
    ...
    public void makeNewEditorPane() {
	final HashMap<String, MutableAttributeSet> assemblerKeywords = new HashMap<String, MutableAttributeSet>(
		16);
	assemblerKeywords.put("mov", DEFAULT_KEYWORD);
	assemblerKeywords.put("xch", DEFAULT_KEYWORD);
	assemblerKeywords.put("xchd", DEFAULT_KEYWORD);
	assemblerKeywords.put("movc", DEFAULT_KEYWORD);
	assemblerKeywords.put("inc", DEFAULT_KEYWORD);
	assemblerKeywords.put("dec", DEFAULT_KEYWORD);
	assemblerKeywords.put("add", DEFAULT_KEYWORD);
	assemblerKeywords.put("subb", DEFAULT_KEYWORD);
	assemblerKeywords.put("clr", DEFAULT_KEYWORD);
	assemblerKeywords.put("swap", DEFAULT_KEYWORD);
	assemblerKeywords.put("mul", DEFAULT_KEYWORD);
	assemblerKeywords.put("div", DEFAULT_KEYWORD);
	assemblerKeywords.put("rl", DEFAULT_KEYWORD);
	assemblerKeywords.put("rr", DEFAULT_KEYWORD);
	assemblerKeywords.put("setb", DEFAULT_KEYWORD);
	assemblerKeywords.put("cpl", DEFAULT_KEYWORD);
	assemblerKeywords.put("anl", DEFAULT_KEYWORD);
	assemblerKeywords.put("orl", DEFAULT_KEYWORD);
	assemblerKeywords.put("xrl", DEFAULT_KEYWORD);
	assemblerKeywords.put("sjmp", DEFAULT_KEYWORD);
	assemblerKeywords.put("jb", DEFAULT_KEYWORD);
	assemblerKeywords.put("jnb", DEFAULT_KEYWORD);
	assemblerKeywords.put("jz", DEFAULT_KEYWORD);
	assemblerKeywords.put("jnz", DEFAULT_KEYWORD);
	assemblerKeywords.put("djnz", DEFAULT_KEYWORD);
	assemblerKeywords.put("cjne", DEFAULT_KEYWORD);
	assemblerKeywords.put("lcall", DEFAULT_KEYWORD);
	assemblerKeywords.put("ret", DEFAULT_KEYWORD);
	assemblerKeywords.put("reti", DEFAULT_KEYWORD);
	assemblerKeywords.put("DB", DEFAULT_KEYWORD);
	assemblerKeywords.put("org", DEFAULT_KEYWORD);
	assemblerKeywords.put("EQU", DEFAULT_KEYWORD);
	assemblerKeywords.put("DATA", DEFAULT_KEYWORD);

	this.editorKit = new StyledEditorKit() {

	    @Override
	    public Document createDefaultDocument() {
		return new Syntax(assemblerKeywords);
	    }
	};
	edit = null;
	edit = new ExtendedJEditorPane();
	edit.setText("");
    ...
    public ExtendedJEditorPane getEditPane() {
